...
http.createServer(function (req, res) { // it waits for a request and a response object 
    console.log(req.headers); //output the request headers to the console
    res.writeHead(200, { 'Content-Type': 'text/html' }); // set MIME type to HTML // The meta information in the head // Can only write 1 head
